...
--Creaci�n de la tabla PAIS la cual se encuentra dentro del Esquema Ubicacion
...
--Creaci�n de la tabla DEPARTAMENTO la cual se encuentra dentro del Esquema Ubicacion
...
--Creaci�n de la tabla CIUDAD la cual se encuentra dentro del Esquema Ubicacion
...
--Creaci�n de la tabla DIRECCION la cual se encuentra dentro del Esquema Ubicacion
...
--NOTA IMPORTANTE: La tabla ASIGNACIONDIRECCION del Esquema "Person" necesariamente tiene que estar en esta posici�n
